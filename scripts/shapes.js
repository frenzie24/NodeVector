...
class Square extends Shape {
    constructor(color, text, textColor) {
        ...
        this.shapeEle = `<rect width="300" height="200" x="0" y="0"  fill="${this.color}" />`;
...
class Circle extends Shape {
    constructor(color, text, textColor) {
        super(color, text, textColor);
        this.shapeEle = `<circle r="35%" cx="50%" cy="50%" fill="${this.color}" />`
...
class Triangle extends Shape {
    constructor(color, text, textColor) {
        super(color, text, textColor);
        this.shapeEle = ` <polygon points="0,200 300,200 150,0" style="fill:${this.color}" />`
